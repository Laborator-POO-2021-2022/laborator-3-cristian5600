...
public:
	...
	friend Fractie operator +(const Fractie &, const Fractie&); // supradefinire operatoradunare
	...
	Fractie& operator +=( const Fractie& a); // supradefinire operator incrementare cu o
	//valoare //se intoarce referinta la Fractie pt a putea face operatii ca : int m ; (m+=5)+=3 ;
//	*this=*this+a;
